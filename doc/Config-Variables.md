...
- `disableDriftDetectionWhenDeploying`: Set to `true` to disable drift detection before terraform apply. Default is `false`. Please refer to [Drift Detection](./Drift-Detection.md) for more details.
